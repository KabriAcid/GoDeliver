<!-- GoDeliver V1.0.0  Initiate Date: 170224T01:17-->
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-10">
                                <h1 class="slick-title">Cool Agents</h1>

                                <p class="lead text-white mt-lg-3 mb-lg-5">GoDeliver is one of the most renowned e-Commerce site with satsifying product services.</p>
            ...
            <div class="slick-custom">
                ...
                <div class="slick-bottom">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-10">
                                <h1 class="slick-title">Appealing Design</h1>

                                <p class="lead text-white mt-lg-3 mb-lg-5">GoDeliver presents customers with an exquisite style of interface and user-experiece.</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-10">
                                ...
                                <p class="lead text-white mt-lg-3 mb-lg-5">You can contact us at our headquarters here in Katsina.</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="mb-5">Get started with <span>GoDeliver</span></h2>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-12">
                                        <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                            <h5 class="mb-3">Good <span>Design</span> <br>Ideas for <span>your</span> fashion</h5>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="px-5 py-5 py-lg-0">
                            ...
                            <p class="lead mb-4">Credits go to Unsplash and FreePik websites for images used in this GoDeliver by Tooplate.</p>
        ...
        <section class="featured-product section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="mb-5">Featured <span>Products</span></h2>
                    </div>
                            ...
                            <div class="product-info d-flex">
                                <div>
                                    <h5 class="product-title mb-0">
                                        <a href="cart.php" class="product-title-link">Tree pot</a>
                                    </h5>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="product-thumb">
                            ...
                            <div class="product-info d-flex">
                                <div>
                                    <h5 class="product-title mb-0">
                                        <a href="cart.php" class="product-title-link">Juice Drinks</a>
                                    </h5>
