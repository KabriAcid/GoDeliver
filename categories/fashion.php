                ...
                <div class="row">
                    <div class="col-2">
                        <div class="sidebar">
                            <ul class="unordered-list">
                                ...
                                <li class="sidebar-icons bg-dark rounded"><a href="fashion.php" class="text-white"><i class="fa fa-shirt"></i><span>Fashion</span></a></li>
                    ...
                    <div class="col-10">
                        <div class="main-content">
                            <div class="container">
                                <h2 class="d-block text-primary">Fashion  </h2><i class=""></i>
                                ...
                                <section class="categories-section">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-1.png" class="product-img">
                                                </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-2.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-3.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-4.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-5.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-6.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-7.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-8.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Apple iWatch</b>
                                                    <?php $price = "85,340";?>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-9.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Apple iWatch</b>
                                                    <?php $price = "85,340";?>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-10.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Apple iWatch</b>
                                                    <?php $price = "85,340";?>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-11.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Apple iWatch</b>
                                                    <?php $price = "85,340";?>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-12.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Apple iWatch</b>
                                                    <?php $price = "85,340";?>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/fashion/fashion-13.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Apple iWatch</b>
                                                    <?php $price = "85,340";?>
