...
<head>
    ...
    <title>Phones - Category Page</title>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="sidebar">
                            <ul class="unordered-list">
                                ...
                                <li class="sidebar-icons bg-dark rounded"><a href="phones.php" class="text-white"><i class="fa fa-mobile"></i><span>Phones</span></a></li>
                    ...
                    <div class="col-10">
                        <div class="main-content">
                            <div class="container">
                                <h2 class="d-block text-primary">Phones and Devices</h2><i class=""></i>
                                ...
                                <section class="categories-section">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-1.png" class="product-img">
                                                </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-2.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-3.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-4.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-5.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-6.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/phones/phone-7.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
