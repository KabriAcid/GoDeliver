...
<head>
    ...
    <title>Gadgets - Category Page</title>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="sidebar">
                            <ul class="unordered-list">
                                ...
                                <li class="sidebar-icons bg-dark rounded"><a href="gadgets.php" class="text-white"><i class="fa fa-tv"></i><span>Computer & Gadgets</span></a></li>
                    ...
                    <div class="col-10">
                        <div class="main-content">
                            <div class="container">
                                <h2 class="d-block text-primary">Gadgets & Computers</h2><i class=""></i>
                                ...
                                <section class="categories-section">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-1.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="product-name">Cannon Camera</b>
                                                    <?php $price = "120,200";?>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-2.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">PS4 Headset</b>
                                                    <?php $price = "45,000";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-3.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Alienware Neon </b>
                                                    <?php $price = "490,000";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-4.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Phantom Drone</b>
                                                    <?php $price = "523,500";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-5.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">PS5 Playstation</b>
                                                    <?php $price = "442,660";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-6.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">Boomplayer XP</b>
                                                    <?php $price = "183,400";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-7.jpg" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">LT Projector</b>
                                                    <?php $price = "705,340";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2">
                                            <div class="product-card">
                                                <div class="d-flex justify-content-center p-4 img-container">
                                                    <img src="../categories/images/gadgets/gadgets-8.png" class="product-img">
                                                </div>
                                                <div class="details-container d-flex justify-content-between p-3 pt-3 align-items-center">
                                                    <b class="">HP Keyboard</b>
                                                    <?php $price = "51,990";?>
                                                    <b class="product-price text-primary"><?php echo "&#8358;" . $price?></b>
                                                </div>
                                                <div class="p-3 py-0">
