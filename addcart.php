...
if(isset($_POST['add'])) {
    if(empty($_POST['title']) || empty($_POST['desc']) || empty($_POST['price'])) {
        ...
        $sql = "INSERT INTO categories (image, title, description, price) VALUES ('$imagePath', '$title', '$desc', '$price')";
        ...
        <section class="section-padding mt-5">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                    <div class="biller-container">
                        <div class="pb-2">
                            <h6 class="text-dark">Add Categories</h6>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="number">Category Price</label>
